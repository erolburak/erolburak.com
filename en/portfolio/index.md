    ...
    <div class="wrapper-collapse-content">
        <div class="wrapper-portfolio">
            <div class="wrapper-portfolio-screenshot-title">
                ...
                <p class="screenshot-title">Browse core data on the map</p>
            </div>
            <div class="wrapper-portfolio-screenshot-title">
                <div class="wrapper-screenshot">
                ...
                <p class="screenshot-title">Create activities</p>
            </div>
        </div>
        <div class="wrapper-portfolio">
            <div class="wrapper-portfolio-screenshot-title">
                ...
                <p class="screenshot-title">Manage farm</p>
            </div>
        </div>
    </div>
</div>
...
<div class="wrapper-collapse">
    ...
    <label for="collapse7" class="collapse-label-toggle">SHOW SCREENSHOTS</label>
    <div class="wrapper-collapse-content">
        <div class="wrapper-portfolio">
            <div class="wrapper-portfolio-screenshot-title">
                <div class="wrapper-screenshot">
