...
<br></br>
<p>Die <b>CLAAS connect Farm Management</b> App bietet die digitale Lösung für die Schlag- und Stammdatenverwaltung an und veranschaulicht diese Informationen in einer übersichtlichen Form. Wichtige Resourcen wie Maschinen, Mitarbeitende, Betriebsmittel und Schläge können angelegt und verwaltet werden. Für ein optimales Management gibt die Karte Auskunft über die Position und den Status der Maschinen. Diese App ist im <a href="https://apps.apple.com/de/app/claas-connect-farm-management/id6475955826" target="_blank">App Store</a> veröffentlicht.</p>
<div class="wrapper-collapse">
    ...
    <div class="wrapper-collapse-content">
        <div class="wrapper-portfolio">
            <div class="wrapper-portfolio-screenshot-title">
                ...
                <p class="screenshot-title">Stammdaten auf der Karte durchstöbern</p>
            </div>
            <div class="wrapper-portfolio-screenshot-title">
                <div class="wrapper-screenshot">
                ...
                <p class="screenshot-title">Arbeitsvorgänge anlegen</p>
            </div>
        </div>
        <div class="wrapper-portfolio">
            <div class="wrapper-portfolio-screenshot-title">
                ...
                <p class="screenshot-title">Betrieb verwalten</p>
            </div>
        </div>
    </div>
</div>
...
<div class="wrapper-collapse">
    <input id="collapse7" class="collapse-toggle" type="checkbox">
    <label for="collapse7" class="collapse-label-toggle">SCREENSHOTS ANZEIGEN</label>
    <div class="wrapper-collapse-content">
        <div class="wrapper-portfolio">
            <div class="wrapper-portfolio-screenshot-title">
                <div class="wrapper-screenshot">
